# Originally from https://github.com/ryan112358/private-pgm/blob/557c077708d3559212a8f65dff3eccd3fd244abb/src/mbi/factor.py
# Modified by Authors under the Apache 2.0 license
# Added static method "normal" for Factor-class
...
class Factor:
    ...
    @staticmethod
    def normal(domain):
        return Factor(domain, np.random.normal(size=domain.shape))
