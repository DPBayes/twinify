...
COMMAND="python ./twinify_nonprivate.py ../tds_all.csv ../models/full_model.txt ../results/full_model_nonprivate/syn_data_$OUT_FILE_NAME %../models/run_params.txt $ARGS"
echo ${COMMAND}
srun $COMMAND
