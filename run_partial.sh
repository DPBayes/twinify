...
COMMAND="python ui.py ./tds_example/tds_all.csv ./tds_example/models/partial_model.txt ./results/partial_model/syn_data_$OUT_FILE_NAME %./tds_example/models/run_params.txt $ARGS"
echo $COMMAND
srun $COMMAND
