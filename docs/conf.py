...
#
html_theme_options = {
    "repository_url": "https://github.com/DPBayes/twinify",
...
html_logo = "../figures/PeopleAfter.jpg"
html_title = "Twinify"
...
latex_documents = [
    (master_doc, 'Twinify.tex', 'Twinify Documentation',
     'DPBayes', 'manual'),
]
...
man_pages = [
    (master_doc, 'twinify', 'Twinify Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Twinify', 'Twinify Documentation',
     author, 'Twinify', 'One line description of project.',
     'Miscellaneous'),
]
